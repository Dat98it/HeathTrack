...
// icons
export {default as ElipseIcon} from './images/Ellipse.png';
export {default as GoogleIcon} from './icons/google.svg';
export {default as FacebookIcon} from './icons/facebook.svg';
export {default as FingerPrintIcon} from './icons/finger-print.svg';
...
export {default as GynecologyIcon} from './icons/Gynecology';
export {default as CadiologyIcon} from './icons/Cadiology';
export {default as DermatologyIcon} from './icons/Dermatology';
export {default as GeneralMedicineIcon} from './icons/GeneralMedicine';
export {default as OdontologyIcon} from './icons/Odontology';
export {default as OncologyIcon} from './icons/Oncology';
export {default as OphtamologyIcon} from './icons/Ophtamology';
export {default as OrthopedicsIcon} from './icons/Orthopedics';
export {default as FavouriteIcon} from './icons/favourite.svg';
export {default as StethoscopeIcon} from './icons/stethoscope.svg';
